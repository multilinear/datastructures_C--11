...
SOURCES=array_unittest.cpp avl_unittest.cpp bheap_unittest.cpp boundedheap_unittest.cpp btree_unittest.cpp dict_unittest.cpp dlist_unittest.cpp ochashtable_unittest.cpp heap_unittest.cpp list_unittest.cpp queue_unittest.cpp redblack_unittest.cpp ringbuffer_unittest.cpp rredblack_unittest.cpp set_unittest.cpp sort_unittest.cpp treehashtable_unittest.cpp trivialdict_unittest.cpp ts_btree_unittest.cpp ts_ringbuffer_unittest.cpp ts_work_queue_unittest.cpp
...
btree_unittest: *.h *.cpp ; $(CC) $(CFLAGS) -O3 -std=c++11 btree_unittest.cpp -o btree_unittest
...
treehashtable_unittest: *.h *.cpp ; $(CC) $(CFLAGS) treehashtable_unittest.cpp -o treehashtable_unittest
...
ts_btree_unittest: *.h *.cpp ;  $(CC) $(CFLAGS) -O3 -std=c++11 $(CFLAGS_THREAD) ts_btree_unittest.cpp -o ts_btree_unittest

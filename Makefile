...
SOURCES=avl_unittest.cpp boundedheap_unittest.cpp btree_unittest.cpp dlist_unittest.cpp heap_unittest.cpp list_unittest.cpp redblack_unittest.cpp rredblack_unittest.cpp ringbuffer_unittest.cpp trivialdict_unittest.cpp ts_btree_unittest.cpp ts_ringbuffer_unittest.cpp ts_work_queue_unittest.cpp
